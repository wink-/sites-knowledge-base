...
| Date | Post | Notes |
|------|------|-------|
| Jul 2025 | Welcome to The Independent Home | Rewritten as personal intro |
| Jul 2025 | Solar Pricing: What I Found When I Actually Looked | Real numbers from solar research |
| Jul 2025 | Where I'm Actually At | Honest status across energy/food/money/skills |

### radianthomesolutions.com
| Date | Post | Notes |
|------|------|-------|
| Jul 2025 | Small job handyman services | Service pages exist |

### terminalschool.com
| Date | Content | Notes |
|------|---------|-------|
| Jul 2025 | Full course (7 modules) | Interactive terminal course |
