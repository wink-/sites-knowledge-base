# Property — Winkky Homestead

## Overview

- 8.2 acres in Pine Valley, NY (Chemung County)
- 1,450 sq ft house (old, currently jacking up a corner to level floors)
- 90 acres joint farmland with uncle (defunct pig farm, mostly wooded)
- Finnish descent -- sauna house with pond between two hills
...
- 2008 Chevy Silverado (daily driver + hauling)
- Kubota commercial mower (0% financing, ~2 years left, ~$200/mo)
- 2023 Tesla Model Y Long Range (EV, used for Uber)
- Cattle panels (tree cages, future garden trellises)
- Bolt cutters / grinder for working with cattle panel

## Growing Areas

- Orchard: 9 fruit trees planted 10/18/2025 (see docs/fruit-trees.md)
- Garden: raised beds built, compost filled, topsoil being added (see docs/garden.md)
- No livestock currently -- barn needs repair first

## Future Projects

- Deer fencing for orchard and garden
- Soil test
- Repair barn (goats/chickens return?)
